...
namespace Ionita_Andreea_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ionita_Andreea_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ionita_Andreea_Lab8Context context,
